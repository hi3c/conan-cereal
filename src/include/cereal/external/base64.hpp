...
namespace cereal
{
  namespace base64
  {
	...
	inline std::string encode(std::string const& unencoded_string) {
		return encode(reinterpret_cast<const unsigned char *>(unencoded_string.c_str()), unencoded_string.size());
	}
